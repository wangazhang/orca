...
describe('electron-builder config', () => {
  ...
  it('matches the Linux desktop entry to Electron window class', () => {
    expect(electronBuilderConfig.linux.desktop.entry.StartupWMClass).toBe('yoha')
  })
  ...
  it('uses AppImage and deb as local Linux targets without changing existing artifact names', () => {
    ...
    expect(electronBuilderConfig.appImage.artifactName).toBe('yoha-linux.${ext}')
    expect(electronBuilderConfig.deb.artifactName).toBe('yoha_${version}_${arch}.${ext}')
