...
// Must match appId in config/electron-builder.config.cjs: macOS files
// notification records under this bundle id, so a stale value would route this
// build's notifications to an installed upstream Orca's identity.
const MACOS_PACKAGED_BUNDLE_ID = 'com.wangazhang.yoha'
