  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        // (ProjectGroup + FolderWorkspace + registered repos) BEFORE the local
        // catalog fetch below, so the sidebar shows them on cold start. Idempotent
        // + fail-soft: a missing/malformed structured projects dir must not block
        // startup.
